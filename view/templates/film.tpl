        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-1 flex flex-col items-center md:items-start">
                    <div
                        ...
                        {if $isLogged}
                            <a href="#" onclick="event.preventDefault(); openAddToWatchlistModal({$film->getId()})"
                                data-watchlist-content-id="{$film->getId()}"
            ...
            <div class="mt-12 space-y-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                    ...
                    {foreach $film->getPartecipazioni() as $p}
                ...
                {else}
                    <div class="grid grid-cols-1 gap-4">
                        {foreach $recensioni as $recensione}
                            {include file="components/cards/cardRecensioneSemplice.tpl" recensione=$recensione contenuto=$film->getId()}
                        {/foreach}
                    </div>
                {/if}
            </div>
