{*
 * Template Navbar (Barra di Navigazione)
 * 
 * Fornisce il menu di navigazione superiore del sito, inclusi il logo, il form di ricerca,
 * e i controlli per l'utente (Link al profilo/Pannello Admin/Logout se loggato, altrimenti
 * pulsanti per attivare i modali di Login e Registrazione).
 * 
 * @package View/Templates/Components
 * @author Marco Viscovo
 * 
 * @param bool $isLogged Indica se l'utente corrente è autenticato.
 * @param EUtente|null $currentUser L'oggetto utente loggato attualmente (null se visitatore).
 * @param string $baseUrl URL base dell'applicazione.
 *}
